...
partial class AdresseView {
    ...
    private void InitializeComponent() {
        ...
        this.bottomBarPanel.Location = new Point(0, 536);
        this.bottomBarPanel.Margin = new Padding(2, 2, 2, 2);
        this.bottomBarPanel.Name = "bottomBarPanel";
        this.bottomBarPanel.Size = new Size(970, 40);
        ...
        this.BtnAction.Location = new Point(647, 5);
        this.BtnAction.Margin = new Padding(2, 2, 2, 2);
        this.BtnAction.Name = "BtnAction";
        this.BtnAction.Size = new Size(154, 33);
        ...
        this.btnAnnuler.Location = new Point(823, 5);
        this.btnAnnuler.Margin = new Padding(2, 2, 2, 2);
        this.btnAnnuler.Name = "btnAnnuler";
        this.btnAnnuler.Size = new Size(118, 33);
        ...
        this.centerTblLayoutPanel.Location = new Point(0, 40);
        this.centerTblLayoutPanel.Margin = new Padding(2, 2, 2, 2);
        ...
        this.centerTblLayoutPanel.Size = new Size(970, 496);
        ...
        this.centerPanel.Location = new Point(287, 2);
        this.centerPanel.Margin = new Padding(2, 2, 2, 2);
        this.centerPanel.Name = "centerPanel";
        this.centerPanel.Size = new Size(396, 492);
        this.centerPanel.TabIndex = 0;
        // 
        // valuedateTimePickerDelete
        // 
        this.valuedateTimePickerDelete.Enabled = false;
        this.valuedateTimePickerDelete.Location = new Point(157, 438);
        this.valuedateTimePickerDelete.Margin = new Padding(2, 2, 2, 2);
        this.valuedateTimePickerDelete.Name = "valuedateTimePickerDelete";
        this.valuedateTimePickerDelete.Size = new Size(237, 27);
        this.valuedateTimePickerDelete.TabIndex = 24;
        // 
        // valuedateTimePickerModified
        // 
        this.valuedateTimePickerModified.Enabled = false;
        this.valuedateTimePickerModified.Location = new Point(157, 397);
        this.valuedateTimePickerModified.Margin = new Padding(2, 2, 2, 2);
        this.valuedateTimePickerModified.Name = "valuedateTimePickerModified";
        this.valuedateTimePickerModified.Size = new Size(237, 27);
        this.valuedateTimePickerModified.TabIndex = 23;
        // 
        // valuedateTimePickerCreate
        // 
        this.valuedateTimePickerCreate.Enabled = false;
        this.valuedateTimePickerCreate.Location = new Point(157, 355);
        this.valuedateTimePickerCreate.Margin = new Padding(2, 2, 2, 2);
        this.valuedateTimePickerCreate.Name = "valuedateTimePickerCreate";
        this.valuedateTimePickerCreate.Size = new Size(237, 27);
        ...
        this.dateCreateabel.Location = new Point(10, 357);
        this.dateCreateabel.Margin = new Padding(2, 0, 2, 0);
        this.dateCreateabel.Name = "dateCreateabel";
        this.dateCreateabel.Size = new Size(120, 25);
        ...
        this.valueAdresseTypeCB.Location = new Point(158, 39);
        this.valueAdresseTypeCB.Margin = new Padding(2, 2, 2, 2);
        this.valueAdresseTypeCB.Name = "valueAdresseTypeCB";
        this.valueAdresseTypeCB.Size = new Size(235, 28);
        this.valueAdresseTypeCB.TabIndex = 18;
        // 
        // valuePostalCode
        // 
        this.valuePostalCode.Location = new Point(157, 309);
        this.valuePostalCode.Margin = new Padding(2, 2, 2, 2);
        this.valuePostalCode.Name = "valuePostalCode";
        this.valuePostalCode.Size = new Size(237, 27);
        this.valuePostalCode.TabIndex = 17;
        // 
        // postalCodeLabel
        // 
        this.postalCodeLabel.Font = new Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point);
        this.postalCodeLabel.Location = new Point(10, 309);
        this.postalCodeLabel.Margin = new Padding(2, 0, 2, 0);
        this.postalCodeLabel.Name = "postalCodeLabel";
        this.postalCodeLabel.Size = new Size(120, 25);
        ...
        // valueCountry
        // 
        this.valueCountry.Location = new Point(157, 273);
        this.valueCountry.Margin = new Padding(2, 2, 2, 2);
        this.valueCountry.Name = "valueCountry";
        this.valueCountry.Size = new Size(237, 27);
        this.valueCountry.TabIndex = 15;
        // 
        // valueState
        // 
        this.valueState.Location = new Point(158, 238);
        this.valueState.Margin = new Padding(2, 2, 2, 2);
        this.valueState.Name = "valueState";
        this.valueState.Size = new Size(235, 27);
        this.valueState.TabIndex = 14;
        // 
        // valueCity
        // 
        this.valueCity.Location = new Point(158, 198);
        this.valueCity.Margin = new Padding(2, 2, 2, 2);
        this.valueCity.Name = "valueCity";
        this.valueCity.Size = new Size(235, 27);
        this.valueCity.TabIndex = 13;
        // 
        // countryLabel
        // 
        this.countryLabel.Font = new Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point);
        this.countryLabel.Location = new Point(10, 273);
        this.countryLabel.Margin = new Padding(2, 0, 2, 0);
        this.countryLabel.Name = "countryLabel";
        this.countryLabel.Size = new Size(120, 25);
        ...
        this.stateLabel.Location = new Point(10, 238);
        this.stateLabel.Margin = new Padding(2, 0, 2, 0);
        this.stateLabel.Name = "stateLabel";
        this.stateLabel.Size = new Size(120, 25);
        ...
        this.cityLabel.Location = new Point(10, 198);
        this.cityLabel.Margin = new Padding(2, 0, 2, 0);
        this.cityLabel.Name = "cityLabel";
        this.cityLabel.Size = new Size(120, 25);
        ...
        // valueStreet
        // 
        this.valueStreet.Location = new Point(158, 154);
        this.valueStreet.Margin = new Padding(2, 2, 2, 2);
        this.valueStreet.Name = "valueStreet";
        this.valueStreet.Size = new Size(235, 27);
        this.valueStreet.TabIndex = 9;
        // 
        // streetLabel
        // 
        this.streetLabel.Font = new Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point);
        this.streetLabel.Location = new Point(10, 154);
        this.streetLabel.Margin = new Padding(2, 0, 2, 0);
        this.streetLabel.Name = "streetLabel";
        this.streetLabel.Size = new Size(120, 25);
