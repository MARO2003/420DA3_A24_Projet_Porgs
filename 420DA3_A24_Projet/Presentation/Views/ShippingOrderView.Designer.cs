...
partial class ShippingOrderView {
    ...
    private void InitializeComponent() {
        ...
        this.statutLbl = new Label();
        this.idlbl = new Label();
        this.CreateAdressebtn = new Button();
        this.ClientSourceCb = new ComboBox();
        ...
        this.panel1.Size = new Size(1140, 72);
        ...
        this.panel3.Location = new Point(0, 588);
        ...
        this.tableLayoutPanel1.Location = new Point(0, 72);
        this.tableLayoutPanel1.Name = "tableLayoutPanel1";
        this.tableLayoutPanel1.RowCount = 1;
        this.tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 100F));
        this.tableLayoutPanel1.Size = new Size(1140, 516);
        this.tableLayoutPanel1.TabIndex = 3;
        // 
        // panel4
        // 
        this.panel4.Controls.Add(this.textBox1);
        this.panel4.Controls.Add(this.Ajouterbtn);
        this.panel4.Controls.Add(this.QuantiteAjoutValue);
        this.panel4.Controls.Add(this.label7);
        this.panel4.Controls.Add(this.productSearchResultsListBox);
        this.panel4.Controls.Add(this.label5);
        this.panel4.Controls.Add(this.label4);
        this.panel4.Controls.Add(this.label3);
        this.panel4.Controls.Add(this.statutLbl);
        this.panel4.Controls.Add(this.idlbl);
        this.panel4.Controls.Add(this.CreateAdressebtn);
        this.panel4.Controls.Add(this.ClientSourceCb);
        this.panel4.Controls.Add(this.label1);
        this.panel4.Controls.Add(this.StatutCb);
        this.panel4.Controls.Add(this.IdValue);
        this.panel4.Dock = DockStyle.Fill;
        this.panel4.Location = new Point(73, 3);
        ...
        this.Ajouterbtn.Size = new Size(186, 34);
        ...
        // QuantiteAjoutValue
        // 
        this.QuantiteAjoutValue.Location = new Point(305, 417);
        this.QuantiteAjoutValue.Name = "QuantiteAjoutValue";
        this.QuantiteAjoutValue.Size = new Size(186, 31);
        this.QuantiteAjoutValue.TabIndex = 13;
        this.QuantiteAjoutValue.Value = new decimal(new int[] { 1, 0, 0, 0 });
        // 
        // label7
        // 
        this.label7.Location = new Point(305, 380);
        this.label7.Name = "label7";
        this.label7.Size = new Size(189, 25);
        this.label7.TabIndex = 12;
        this.label7.Text = "Quantite a ajouter:";
        this.label7.TextAlign = ContentAlignment.MiddleLeft;
        // 
        // productSearchResultsListBox
        // 
        this.productSearchResultsListBox.Anchor =  AnchorStyles.Bottom | AnchorStyles.Left;
        this.productSearchResultsListBox.FormattingEnabled = true;
        this.productSearchResultsListBox.ItemHeight = 25;
        this.productSearchResultsListBox.Location = new Point(3, 353);
        ...
        this.label5.Location = new Point(0, 284);
        this.label5.Name = "label5";
        this.label5.Size = new Size(408, 25);
        ...
        // label4
        // 
        this.label4.Location = new Point(3, 171);
        this.label4.Name = "label4";
        this.label4.Size = new Size(198, 25);
        this.label4.TabIndex = 8;
        this.label4.Text = "Adresse de destination:";
        ...
        this.label3.Text = "Client source";
        this.label3.TextAlign = ContentAlignment.TopRight;
        // 
        // statutLbl
        // 
        this.statutLbl.Location = new Point(3, 49);
        this.statutLbl.Name = "statutLbl";
        this.statutLbl.Size = new Size(147, 25);
        this.statutLbl.TabIndex = 6;
        this.statutLbl.Text = "Statut:";
        this.statutLbl.TextAlign = ContentAlignment.TopRight;
        // 
        // idlbl
        // 
        this.idlbl.Location = new Point(0, 5);
        this.idlbl.Name = "idlbl";
        this.idlbl.Size = new Size(147, 25);
        ...
        // CreateAdressebtn
        // 
        this.CreateAdressebtn.Location = new Point(196, 166);
        this.CreateAdressebtn.MinimumSize = new Size(112, 34);
        this.CreateAdressebtn.Name = "CreateAdressebtn";
        this.CreateAdressebtn.Size = new Size(112, 34);
        ...
        // ClientSourceCb
        // 
        this.ClientSourceCb.FormattingEnabled = true;
        this.ClientSourceCb.Location = new Point(153, 123);
        this.ClientSourceCb.Name = "ClientSourceCb";
        this.ClientSourceCb.Size = new Size(338, 33);
        this.ClientSourceCb.TabIndex = 3;
        // 
        // label1
        // 
        this.label1.AutoSize = true;
        this.label1.Location = new Point(153, 95);
        this.label1.Name = "label1";
        this.label1.Size = new Size(174, 25);
        this.label1.TabIndex = 2;
        this.label1.Text = "Recherche de clients:";
        this.label1.TextAlign = ContentAlignment.MiddleRight;
        // 
        // StatutCb
        // 
        this.StatutCb.FormattingEnabled = true;
        this.StatutCb.Location = new Point(153, 49);
        this.StatutCb.Name = "StatutCb";
        this.StatutCb.Size = new Size(338, 33);
        this.StatutCb.TabIndex = 1;
        // 
        // IdValue
        // 
        this.IdValue.Location = new Point(153, 3);
        ...
        this.panel5.Controls.Add(this.CreatingEmployeeValue);
        this.panel5.Controls.Add(this.UpdatedDateTimePicker2);
        this.panel5.Controls.Add(this.label9);
        this.panel5.Controls.Add(this.label8);
        this.panel5.Controls.Add(this.createdDateTimePicker1);
        this.panel5.Controls.Add(this.label2);
        this.panel5.Dock = DockStyle.Fill;
        this.panel5.Location = new Point(573, 3);
        ...
        // 
        this.deletedDatedateTimePicker1.Location = new Point(190, 171);
        this.deletedDatedateTimePicker1.Name = "deletedDatedateTimePicker1";
        this.deletedDatedateTimePicker1.Size = new Size(301, 31);
        this.deletedDatedateTimePicker1.TabIndex = 20;
        // 
        // label12
        // 
        this.label12.Location = new Point(3, 171);
        this.label12.Name = "label12";
        this.label12.Size = new Size(181, 25);
        ...
        this.ClientSize = new Size(1140, 632);
        ...
        ((System.ComponentModel.ISupportInitialize) this.QuantiteAjoutValue).EndInit();
    ...
    private ComboBox ClientSourceCb;
    private Label label1;
    private ComboBox StatutCb;
    private NumericUpDown IdValue;
    private Panel panel5;
    private Label label3;
    private Label statutLbl;
    private Label idlbl;
    private Button CreateAdressebtn;
    private Button Ajouterbtn;
    private NumericUpDown QuantiteAjoutValue;
    private Label label7;
    private ListBox productSearchResultsListBox;
    private Label label5;
    private Label label4;
    private DateTimePicker createdDateTimePicker1;
    private Label label2;
    private Label label8;
    private TextBox CreatingEmployeeValue;
    private DateTimePicker UpdatedDateTimePicker2;
